...
export const canVisionModel = (model: string) => {
  ...
  // if (['gpt-4-all', 'gpt-4-v', 'gpt-4v', 'gpt-3.5-net', 'gpt-4o', 'gpt-3.5-turbo-0301'].includes(model))
  //   return true
...
export const isCanBase64Model = (model: string) => {
  // gpt-4o
  // customVisionModel
  const visionArr = ['gemini-pro-vision', 'gpt-4o', 'gpt-4o-2024-05-13', 'gemini-pro-1.5', 'gpt-4-turbo', 'gpt-4-turbo-2024-04-09', 'gpt-4-vision-preview', defaultVisionModel()]
