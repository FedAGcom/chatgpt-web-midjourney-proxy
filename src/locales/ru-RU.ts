export default {
  ...
  chat: {
    ...
    placeholderMobile: 'Начните писать',
    copy: 'Копировать',
    copied: 'Скопировано',
    ...
    deleteHistoryConfirm: 'Вы уверены, что хотите удалить этот чат?',
  ...
  mj: {
    ...
    micWhisper: 'Записать голосовое сообщение',
  ...
  mjtab: {
    chat: 'Чат',
    draw: 'Изображение',
    drawinfo: 'Создавайте изображения, используя Midjourney и DALLE 3',
    gallery: 'Галерея',
  ...
  mjchat: {
    ...
    fluxInfo: 'Это самая современная модель для генерации изображений, обеспечивающая первоклассное выполнение промптов, визуальное качество, детализацию изображений и разнообразие результатов.',
    version: 'Версия',
    dalleOptions: 'Опции',
    size: 'Размер',
