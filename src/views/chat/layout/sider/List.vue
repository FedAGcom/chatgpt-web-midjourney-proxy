      ...
      <template v-else>
        <div v-for="(item, index) of dataSources" :key="index">
          <a
            ...
            :class="isActive(item.uuid) && ['border-[#126eb0]', 'bg-neutral-100', 'text-[#126eb0]', 'dark:bg-[#24272e]', 'dark:border-[#126eb0]', 'pr-14']"
          ...
          >
            ...
            <div v-if="isActive(item.uuid)" class="absolute z-10 flex visible right-1">
              ...
              <template v-else>
                ...
                <NPopconfirm placement="bottom" positive-text="Да" negative-text="Нет" @positive-click="handleDeleteDebounce(index, $event)">
                  <template #trigger>
                    <button class="p-1">
