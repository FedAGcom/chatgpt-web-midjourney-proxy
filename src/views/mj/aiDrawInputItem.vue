...
<template>
  ...
  <div class="overflow-y-auto bg-[#fafbfc] px-4 dark:bg-[#18181c] h-full ">
    ...
    <section class="mb-4 flex justify-between items-center">
      ...
      <NInputNumber v-model:value="f.cw" :min="0" :max="100" class="!w-[60%]" size="small" clearable placeholder="0-100 уровень роли" />
    </section>
    ...
    <section class="mb-4 flex justify-between items-center">
      ...
      <NInput v-model:value="f.sref" size="small" placeholder="URL-адрес изображения генерирует изображения в том же стиле" clearable>
        <template #suffix>
    ...
    <section class="mb-4 flex justify-between items-center">
      ...
      <NInput v-model:value="f.cref" size="small" placeholder="URL-адрес изображения генерирует изображение с тем же символом" clearable>
        <template #suffix>
